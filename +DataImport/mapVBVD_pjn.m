...
% 5/01/2023 Peter Niedbalski update to handle a bug in the way UTE image
% data is written out in the in-house UTE sequence used at KUMC.
% 
% 
% Input:
% 
...
for s=1:NScans
    ...
    twix_obj{s}.image         = DataImport.twix_map_obj_pjn(arg,'image',filename,version,rstraj);
    twix_obj{s}.noise         = DataImport.twix_map_obj_pjn(arg,'noise',filename,version);
    twix_obj{s}.phasecor      = DataImport.twix_map_obj_pjn(arg,'phasecor',filename,version,rstraj);
    twix_obj{s}.phasestab     = DataImport.twix_map_obj_pjn(arg,'phasestab',filename,version,rstraj);
    twix_obj{s}.phasestabRef0 = DataImport.twix_map_obj_pjn(arg,'phasestab_ref0',filename,version,rstraj);
    twix_obj{s}.phasestabRef1 = DataImport.twix_map_obj_pjn(arg,'phasestab_ref1',filename,version,rstraj);
    twix_obj{s}.refscan       = DataImport.twix_map_obj_pjn(arg,'refscan',filename,version,rstraj);
    twix_obj{s}.refscanPC     = DataImport.twix_map_obj_pjn(arg,'refscan_phasecor',filename,version,rstraj);
    twix_obj{s}.refscanPS     = DataImport.twix_map_obj_pjn(arg,'refscan_phasestab',filename,version,rstraj);
    twix_obj{s}.refscanPSRef0 = DataImport.twix_map_obj_pjn(arg,'refscan_phasestab_ref0',filename,version,rstraj);
    twix_obj{s}.refscanPSRef1 = DataImport.twix_map_obj_pjn(arg,'refscan_phasestab_ref1',filename,version,rstraj);
    twix_obj{s}.RTfeedback    = DataImport.twix_map_obj_pjn(arg,'rtfeedback',filename,version,rstraj);
    twix_obj{s}.vop           = DataImport.twix_map_obj_pjn(arg,'vop',filename,version); % tx-array rf pulses
